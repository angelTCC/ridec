...
type Tab = "events" | "opportunities" | "blog";
  ...
  return (
    <div className="admin-layout">
      <aside className="admin-sidebar">
        <h2 className="admin-sidebar__title">Colab Panel</h2>
        ...
        <div className="admin-header">
          <div>
            ...
            <p className="admin-header__subtitle">
              {tab === "events" && "Crea y administra eventos"}
              {tab === "opportunities" && "Crea y administra oportunidades"}
              {tab === "blog" && "Crea y administra publicaciones"}
            </p>
          </div>
